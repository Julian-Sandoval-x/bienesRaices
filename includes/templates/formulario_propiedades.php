...
<fieldset>
    ...
    <select name="propiedad[idVendedor]" id="vendedor">
        ...
        <?php foreach ($vendedores as $vendedor) { ?>
            <option <?php echo $propiedad->idVendedor === $vendedor->idVendedor ? 'selected' : '' ?> value="<?php echo s($vendedor->idVendedor) ?>"><?php echo s($vendedor->nombre) . " " . s($vendedor->apellido); ?></option>
        <?php } ?>
    </select>
</fieldset>